/**
 * @file		avrlib/trunk/core/isb_fw_app.c
 *
 * @brief		iSysBus Firmware-App-Core.
 *
 * This file includes the iSysBus Firmware-App-Core.
 *
...
#ifndef ISB_FW_APP_C_
	#define ISB_FW_APP_C_
...
//		#include <avr/interrupt.h>
		...
		static const uint8_t Isb_Firmware_Code[4] = { 0x00, 0x00, 0x00, 0x00 };

//		#include "def.h"
//		#include "def_isb.h"
//		#include "typ_isb.h"
		#include "isb_fw_app.h"
	...
	static uint16_t Isb_Node_Id = 0;
	static uint8_t Isb_Firmware_Offset = 0;
	static uint8_t Isb_Node_Operating_Mode = 0;
...
//	#include "./../lib/isb_ch.h"
	...
	#include "./../lib/isb_grp.h"
		...
		#include "./../lib/if_twi_def.h"
		#include "./../lib/if_twi.h"
