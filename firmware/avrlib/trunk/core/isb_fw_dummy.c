/**
 * @file		avrlib/trunk/core/isb_fw_dummy.c
 *
 * @brief		iSysBus Firmware-Dummy-Core.
 *
 * This file includes the iSysBus Firmware-Dummy-Core.
 *
 ...
 */
...
#ifndef ISB_FW_DUMMY_C_
	#define ISB_FW_DUMMY_C_
	...
	#include "./../lib/lib_pin.c"
		...
		#include "./../lib/isb_inf_ethernet_def.h"
//		#include "./../lib/inf_ethernet_def.h"
//		#include "./../lib/lib_enc28j60_def.h"
//		#include "./../lib/inf_spi_def.h"
		#include "./../lib/isb_inf_ethernet.h"
//		#include "./../lib/inf_ethernet.h"
//		#include "./../lib/lib_enc28j60.h"
//		#include "./../lib/inf_spi.h"
		#include "./../lib/lib_crc.h"
		#include "./../lib/lib_crc.c"
//		#include "./../lib/inf_spi.c"
//		#include "./../lib/lib_enc28j60.c"
//		#include "./../lib/inf_ethernet.c"
		#include "./../lib/isb_inf_ethernet.c"
...
//					}
			...
			#endif /* ISB_INF_CAN2 == 1 */
			#if ISB_INF_ETHERNET == 1
				if (Isb_Inf_Ethernet_Rx(&Isb_Msg) == TRUE) {
					#if ISB_INF_USART0 == 1
						Isb_Inf_Usart_Tx(0, &Isb_Msg);
					#endif /* ISB_INF_USART0 == 1 */
					#if ISB_INF_USART1 == 1
