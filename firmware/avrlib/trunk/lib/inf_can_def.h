 ...
 *
 * @date		$Date: 2012-05-06 00:37:39 +0200 (So, 06. Mai 2012) $
 *
 * @version		$Rev: 7688 $
 *
 * @note
 ...
 */
	...
	#define INF_CAN_DEF_H_
			...
			#define INF_CAN0_SPICFG							(1<<SPE) | (1<<MSTR) | (0<<SPR1) | (1<<SPR0)
			...
			#define IF_CAN0_SS_DDR							DDRB
			#define IF_CAN0_SS_DDX							DDB0
			#define IF_CAN0_SS_PORT							PORTB
			#define IF_CAN0_SS_PORTX						PB0
		#elif INF_CAN0_SS == PORTB_PIN2
			#define INF_CAN0_SSPORT							0x02
			#define INF_CAN0_SSPIN							0x02
			#define IF_CAN0_SS_DDR							DDRB
			#define IF_CAN0_SS_DDX							DDB2
			#define IF_CAN0_SS_PORT							PORTB
			#define IF_CAN0_SS_PORTX						PB2
		#elif INF_CAN0_SS == PORTB_PIN4
			#define INF_CAN0_SSPORT							0x02
			#define INF_CAN0_SSPIN							0x04
			#define IF_CAN0_SS_DDR							DDRB
			#define IF_CAN0_SS_DDX							DDB4
			#define IF_CAN0_SS_PORT							PORTB
			#define IF_CAN0_SS_PORTX						PB4
		#else
			...
			#define IF_CAN0_RS_DDR							DDRC
			#define IF_CAN0_RS_DDX							DDC2
			#define IF_CAN0_RS_PORT							PORTC
			#define IF_CAN0_RS_PORTX						PC2
		#elif INF_CAN0_RS == MCP2515_RX0BF
			#define INF_CAN0_RSPORT							0xFC
			#define INF_CAN0_RSPIN							0x00
		#elif INF_CAN0_RS == MCP2515_RX1BF
			#define INF_CAN0_RSPORT							0xFD
			#define INF_CAN0_RSPIN							0x00
		#else
			...
			#define INF_CAN1_SPICFG							(1<<SPE) | (1<<MSTR) | (0<<SPR1) | (1<<SPR0)
			// T1 15, T2 5 BTQ 20 SP% 75 SJW 1 Err% 0
			...
			#define IF_CAN1_SS_DDR							DDRB
			#define IF_CAN1_SS_DDX							DDB2
			#define IF_CAN1_SS_PORT							PORTB
			#define IF_CAN1_SS_PORTX						PB2
		#elif INF_CAN1_SS == PORTB_PIN4
			#define INF_CAN1_SSPORT							0x02
			#define INF_CAN1_SSPIN							0x04
			#define IF_CAN1_SS_DDR							DDRB
			#define IF_CAN1_SS_DDX							DDB4
			#define IF_CAN1_SS_PORT							PORTB
			#define IF_CAN1_SS_PORTX						PB4
		#else
			...
			#define IF_CAN1_RS_DDR							DDRC
			#define IF_CAN1_RS_DDX							DDC2
			#define IF_CAN1_RS_PORT							PORTC
			#define IF_CAN1_RS_PORTX						PC2
			...
			#define INF_CAN2_SPICFG							(1<<SPE) | (1<<MSTR) | (0<<SPR1) | (1<<SPR0)
			// T1 15, T2 5 BTQ 20 SP% 75 SJW 1 Err% 0
			...
			#define INF_CAN2_SS_DDR							DDRB
			#define INF_CAN2_SS_DDX							DDB2
			#define INF_CAN2_SS_PORT						PORTB
			#define INF_CAN2_SS_PORTX						PB2
		#elif INF_CAN2_SS == PORTB_PIN4
			#define INF_CAN2_SSPORT							0x02
			#define INF_CAN2_SSPIN							0x04
			#define INF_CAN2_SS_DDR							DDRB
			#define INF_CAN2_SS_DDX							DDB4
			#define INF_CAN2_SS_PORT						PORTB
			#define INF_CAN2_SS_PORTX						PB4
		#else
			...
			#define IF_CAN2_RS_DDR							DDRC
			#define IF_CAN2_RS_DDX							DDC2
			#define IF_CAN2_RS_PORT							PORTC
			#define IF_CAN2_RS_PORTX						PC2
