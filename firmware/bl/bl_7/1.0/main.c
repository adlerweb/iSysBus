...
#include <1.0.0/core/isb_bl.h>



const uint8_t Isb_Bootloader_Code[4] = { 0x07, 0x00, 0x01, 0x00 };



#define ISB_NODE_IDENTIFY PORTB_PIN2
...
#define ISB_INF CAN0
	...
	#define ISB_INF_CAN0_INT INTERRUPT1
#endif /* ISB_INF == CAN0 */



#include <1.0.0/core/isb_bl.c>
