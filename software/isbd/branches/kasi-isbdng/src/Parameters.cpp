...
void define_parameters(int argc, char *argv[]) {
	...
	params.addParam("regenerate", 'r', ParamContainer::novalue, "Regenerate null checksums");
...
void parse_parameters(void) {
	...
	if (params["regenerate"] != "") settings.setRegenerate(true);
 ...
 void print_version(void) {
 	...
 	cout << "isbd Version " << settings.getProgramVersion() << " (Revision: " << REVISION << "(" << LAST_CHANGE <<")\n";
