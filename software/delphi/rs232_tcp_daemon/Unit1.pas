...
uses
  ...
  IdBaseComponent, IdComponent, IdTCPServer, IdContext, ScktComp;
...
sendnet(mmsg);
SendMsg(mmsg);
decodenet('!CAN 0037 001E 00 02 04 01210101');
...
procedure TForm1.sendnet(Msg: TPacket);
var
  i:integer;
...
Begin
TidContext(IdTCPServer1.Contexts.LockList.Items[i]).Connection.IOHandler.WriteLn(MessageString);
end;
...
begin
Memo1.Lines.Add('TCP Clienent added');
...
function TForm1.decodenet(MessageString: String): TPacket;
var
 s:String;
 dataString:string;
 Strings:TStringList;
...
function TForm1.HexToInt(HexNum: string): LongInt;
begin
